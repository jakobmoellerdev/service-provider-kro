...
import (
	...
	"github.com/jakobmoellerdev/service-provider-kro/api/crds"
	...
	krosv1alpha1 "github.com/jakobmoellerdev/service-provider-kro/api/v1alpha1"
	"github.com/jakobmoellerdev/service-provider-kro/internal/controller"
...
func main() {
	...
	if err := (&controller.KROReconciler{
		OnboardingCluster: onboardingCluster,
		PlatformCluster:   platformCluster,
		ClusterAccessReconciler: clusteraccess.NewClusterAccessReconciler(platformCluster.Client(), "kro").
